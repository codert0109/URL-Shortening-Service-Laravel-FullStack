    ...
    <x-card class="p-10 max-w-6xl mx-auto mt-24">
        ...
        @csrf
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="name" {{--NOTE THAT WITH THIS VALUE WE NEED QUOTE MARKS TO AVOID A BUG IN PRESENTATION--}} value="{{old('name')}}"/>
            @error('name')
            ...
            <div class="mb-6">
                ...
                <input
                type="password" class="border border-gray-200 rounded p-2 w-full" name="password_confirmation"/>
            ...
            <div class="mt-8">
                <p> Already have an account? <a href="/login" class="text-laravel"
                >Login</a>
                </p>
            </div>
        </form>
